...
Raw sensor measurements must be calibrated to column density (atoms/cm²) before they can be ingested by the retrieval algorithm
  The details of calibration are out of scope of this manuscript, but can be found in (FIXME: cite Alex calibration paper.)

  Calibration reverses many of the terms of the emission model given in the previous section and additional distortion introduced by the instrument, resulting in an expression that is independent of any instrument parameters or solar conditions
